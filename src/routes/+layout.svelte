...
<div
	...
	class:hidden={$page.url.pathname === '/create' || $page.url.pathname.startsWith('/messages/convo/')}
>
	<h1>Refresh</h1>
</div>
...
{#if $page.url.pathname === '/'}
	<div 
		...
		<a href="/messages" class="py-2 px-3">
...
{:else if $page.url.pathname === '/All'}
	...
	<div 
		...
		on:touchmove={handleTouchMove}
		on:touchend={handleTouchEnd}>
		<a href="/All" class="py-2 px-3">
			<Icon icon="fluent:ios-arrow-24-filled" class="w-7 h-7" />
		</a>
		<h1 class="text-3xl font-bold mb-5">Your projects</h1>
	</div>
	...
	<div 
		...
		<h1 class="text-3xl font-bold mb-5">Your tasks</h1>
	</div>
{/if}
